...
#ifndef TOPIC_STATISTICS_SAMPLE__LASER_TALKER_HPP_
#define TOPIC_STATISTICS_SAMPLE__LASER_TALKER_HPP_
...
class LaserTalker : public rclcpp::Node
{
public:
  LaserTalker(
...
#endif  // TOPIC_STATISTICS_SAMPLE__LASER_TALKER_HPP_
